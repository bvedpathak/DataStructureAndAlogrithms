...
class BinarySearchTree:
    ...
    def is_same_tree(self, t1, t2):
        ...
        return t1.value == t2.value and self.is_same_tree(t1.left, t2.left) and self.is_same_tree(t1.right, t2.right)
...
print(f"Are the two trees same: {my_tree.is_same_tree(my_tree.root, my_tree1.root) if my_tree is not None else False}")
print("\n")
